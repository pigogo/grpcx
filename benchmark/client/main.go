...
import (
	...
	"github.com/pigogo/grpcx/benchmark"
	testpb "github.com/pigogo/grpcx/benchmark/grpc_testing"
	"github.com/pigogo/grpcx/benchmark/stats"
	"github.com/pigogo/grpcx/grpclog"
	"github.com/pigogo/grpcx/internal/syscall"
...
func buildConnections(ctx context.Context) []*grpc.ClientConn {
	...
	for i := range ccs {
		ccs[i] = benchmark.NewClientConnWithContext(ctx, "localhost:"+*port, grpc.WithBlock(), grpc.WithReaderWindowSize(int32(16*1024)))
	}
	return ccs
}
